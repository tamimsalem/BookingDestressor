(function() {
    ...
    function removeStressFactors() {
        document
            .querySelectorAll('.js_sr_persuation_msg, .hprt-table-cheapest-block-banner-wrapper, .urgency_message_x_people, .fe_banner__red, .only_x_left, .hp-rt-recently-booked, .top_scarcity, .hp-rt-just-booked')
